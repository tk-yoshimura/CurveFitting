...
namespace CurveFitting.Tests {
    ...
    public class LevenbergMarquardtTests {
        ...
        public void ExecuteFittingTest() {
            ...
            LevenbergMarquardtMethod fitting = new(data_list, new FittingFunction(2, fitting_func, fitting_diff_func));

            Assert.AreEqual(0, (fitting.ExecuteFitting(new Vector(7, 2)) - p).Norm, 1e-10);
        }
    }
}